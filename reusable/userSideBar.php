...
?>
    ...
    <div class=" bg-white flex flex-col w-1/4">
        ...
        <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
            ...
            ?>
                <a href="<?php echo $base_path; ?>/users/userDashboard.php"
                ...
                <a href="<?php echo $base_path; ?>/users/showQR.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $base_path; ?>/users/searchCafes.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $base_path; ?>/users/reviewStores.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $base_path; ?>/users/visited.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $base_path; ?>/users/wishList.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo $base_path; ?>/users/events.php"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if ($_SESSION['is_admin'] === 1): // Only for admins 
                ?>
                    <div class="pt-4 mt-4 border-t">
                        <a href="<?php echo $base_path; ?>/admin/adminDashboard.php"
                            class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition duration-150 ease-in-out">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
